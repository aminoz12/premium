...
const TOOL_URL = `${SITE_URL}/tools/ai-agent-video`
...
export const metadata: Metadata = {
  ...buildToolMetadata("ai-agent-video"),
  title: "Free AI Page Builder — Generate Landing Pages, Portfolios & Dashboards",
  description:
    "Build web pages with AI in seconds. Generate landing pages, portfolios, and dashboards — live preview, HTML export, Three.js, GSAP. Free, no account.",
  keywords: [
...
export default function Page() {
  return (
    <>
      ...
      >
        <QuickAnswer
          question="How do I generate a web page with AI from a text description?"
          answer="Describe the page you need in plain text (e.g., 'Modern portfolio site for a UX designer, light theme, hero with profile photo placeholder, 3-column projects grid, contact form'), select a CSS framework and optional libraries (Three.js, GSAP, Chart.js), then click Generate. The AI builds a complete HTML file with live preview. Download the file or copy the source code — it runs anywhere without a build step."
        />
        <ClientPage />
